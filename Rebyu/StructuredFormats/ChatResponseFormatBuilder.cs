namespace Rebyu.StructuredFormats;

public static class ChatResponseFormatBuilder
{
    public enum ChatResponseStrategy
    {
        Continuation,
        Termination
    }
    
    public static string BuildFormat(ChatResponseStrategy strategyType)
    {
        switch (strategyType)
        {
